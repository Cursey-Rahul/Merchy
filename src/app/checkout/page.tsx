...
import { faGooglePay, faPaypal, faAmazonPay, faApplePay } from "@fortawesome/free-brands-svg-icons";
...
const CheckoutPage = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen p-4 md:p-32'>
      <div className='flex flex-col justify-center w-full max-w-2xl p-12 bg-gray-200 rounded-lg shadow-md gap-5'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <Input type="tel" placeholder="Phone Number" className='border border-gray-900' />
        </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent className="flex flex-col gap-4 text-balance">
                ...
                <Button className='h-10'>
                  <span className='flex flex-row gap-1 items-center justify-center'>
                    <FontAwesomeIcon icon={faApplePay} size='2xl' />
                    Apple Pay
                  </span>
                </Button>
              </AccordionContent>
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="flex flex-col gap-4 text-balance">
                <Button className='text-white' variant='destructive'>Coming soon...</Button>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>

        <Button className='bg-red-500 text-white p-2 rounded-lg text-base text-nowrap uppercase px-14 mx-auto'>
          <span className='text-white'>Place Order</span>
        </Button>

        <p className='text-sm text-gray-500 text-center'>
          By placing an order, you agree to our{' '}
          <Link href="/terms" className='text-blue-500 underline'>Terms & Conditions</Link>
          {' '}and{' '}
