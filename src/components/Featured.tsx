      ...
      <div className="w-max flex">
        {foodProducts.map((product) => (
          <Link 
            ...
            key={product.id}
            className='w-screen h-[60vh] flex flex-col items-center justify-around py-4 px-4 text-center hover:bg-fuchsia-50 transition-all duration-300 md:w-[50vw] lg:w-[33vw] lg:h-[90vh] md:h-[75vh]'
          >
            <div className='relative w-full flex-1'>
              <Image 
                ...
                alt={product.title}
                fill 
                className='object-contain hover:scale-105 duration-500 transition-transform'
              />
            </div>
            <div className='text-red-500 flex flex-1 flex-col gap-4 items-center justify-center'>
              <h1 className='font-bold text-2xl uppercase md:text-3xl lg:text-4xl'>
                {product.title}
              </h1>
